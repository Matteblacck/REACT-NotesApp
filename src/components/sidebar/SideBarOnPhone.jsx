...
export default function SideBar({
  ...
  onSelectNote,
  activeNoteId,
  setSidebarOpen, // Проп для обновления состояния sidebarOpen
}) {
    ...
    .map((note) => (
      <NoteItem
        ...
        onClick={() => {
          ...
          setSidebarOpen(false); // Закрываем сайдбар при выборе заметки
        }}
      >
        <div>
    ...
    <SidebarContainer>
      <HeaderContainer className="d-flex flex-column">
        <div className="d-flex flex-column">
          <h2 style={{ fontSize: '35px '}} className="text-start pt-2">
            Your notes
          </h2>
